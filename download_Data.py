...
TIME_INTERVAL = 240 ##candlestick length in minutes
#symbol = 'DOTUSDT' ##symbol to download for later use
symbol = "BTCUSDT"
#symbol="ETHUSDT"
#symbol = "DOGEUSDT"
#symbol = 'ADAUSDT'
...
LENGTH = '2 year ago UTC' ##time period
...
try:
    ...
    dump(price_data, f"C:\\Users\\conor\\Desktop\\price_data\\{symbol}_{TIME_INTERVAL}_{LENGTH}.joblib") ## address of where you will keep the data,

...
trailing_stop_callback = .3
trading_threshold = .2 ## used to cancel trades that have moved this distance in % away from our attempted entry price
...
make_decision_options = {'look_back_period': 24, 'volume_mult': 3}
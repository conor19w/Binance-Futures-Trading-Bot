...
#SOCKET = "wss://stream.binance.com:9443/ws/adausdt@kline_3m"
#symbol="ADAUSDT"
...
#SOCKET = "wss://stream.binance.com:9443/ws/bakeusdt@kline_3m"
#symbol="BAKEUSDT"
...
break_even_Amount = [.1,.2,.4,.6]  ##what to set the new stop loss at
